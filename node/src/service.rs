...
pub fn new_partial(config: &Configuration) -> Result<Service, ServiceError> {
	...
	let frontier_backend = crate::eth::new_frontier_backend(client.clone(), config)
		.map_err(|e| ServiceError::Application(Box::new(std::io::Error::new(std::io::ErrorKind::Other, e))))?;
